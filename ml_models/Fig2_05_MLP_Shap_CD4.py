...
checkpoint = torch.load('/home/emma/data/CART/CD4_MLP_complete_model_logits.pth')
...
scaler = joblib.load('/home/emma/data/CART/CD4_MLP_scaler_logits.pkl')
...
shap_values_path = '/home/emma/result/CART/CD4_MLP_shap_values.h5'
...
plt.tight_layout()
plt.savefig('/home/emma/result/CART/CD4_MLP_shap_bar.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/emma/result/CART/CD4_MLP_shap_violin.png', dpi=300, bbox_inches='tight')
plt.close()

print("\nAnalysis complete! Files saved:")
print(f"- SHAP values: {shap_values_path}")
print("- Bar plot: /home/emma/result/CART/CD4_MLP_shap_bar.png")
print("- Violin plot: /home/emma/result/CART/CD4_MLP_shap_violin.png")