...
checkpoint = torch.load('/home/emma/data/CART/CD4_MLP_complete_model_logits_newCluster.pth')
...
scaler = joblib.load('/home/emma/data/CART/CD4_MLP_scaler_logits_newCluster.pkl')
...
shap_values_path = '/home/emma/result/CART/CD4_MLP_shap_values_newCluster.h5'
...
plt.tight_layout()
plt.savefig('/home/emma/result/CART/CD4_MLP_shap_bar_newCluster_01.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/emma/result/CART/CD4_MLP_shap_violin_newCluster_01.png', dpi=300, bbox_inches='tight')
plt.close()

print("\nAnalysis complete! Files saved:")
print(f"- SHAP values: {shap_values_path}")
print("- Bar plot: /home/emma/result/CART/CD4_MLP_shap_bar_pr85.png")
print("- Violin plot: /home/emma/result/CART/CD4_MLP_shap_violin_pr85.png")