...
peak_files <- c(
  "GSM5171832_Day0-CD8-CM-1_peaks.narrowPeak",
  "GSM5171833_Day0-CD8-CM-2_peaks.narrowPeak",
  "GSM5171834_Day0-CD8-N-1_peaks.narrowPeak",
  "GSM5171835_Day0-CD8-N-2_peaks.narrowPeak",
  "GSM5171844_Day7-CD8-CM-CD19-1_peaks.narrowPeak",
  "GSM5171845_Day7-CD8-CM-CD19-2_peaks.narrowPeak",
  "GSM5171848_Day7-CD8-N-CD19-1_peaks.narrowPeak",
  "GSM5171849_Day7-CD8-N-CD19-2_peaks.narrowPeak",
  "GSM5171860_Day14-CD8-CM-CD19-1_peaks.narrowPeak",
  "GSM5171861_Day14-CD8-CM-CD19-2_peaks.narrowPeak",
...
# Load the saved data
filtered_peaks <- readRDS("filtered_peaks_CD4.rds")
peak_annotation <- readRDS("peak_annotation_CD4.rds")
peak_annotation_df <- readRDS("peak_annotation_df_CD4.rds")
count_matrix <- readRDS("count_matrix_CD4.rds")
